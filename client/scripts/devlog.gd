...
const ENTRIES: Array[Dictionary] = [
	{
		...
		"notes": [
			...
			"This is a first pass and it is not finished: the cave is still very orange, the seams are still drawn at one width wherever you look, and the floor stays flatter than the walls.",
		],
	},
	{
		"version": "0.11.0",
