...
const ENTRIES: Array[Dictionary] = [
	{
		...
		"notes": [
			...
			"This is the close-up companion to the stretches of ground described below: that change decides what a part of the Reach is made of, this one decides what a single stride of it looks like. It is nowhere near finished. The slabs lie flat against the ground rather than sitting proud of the ash with real thickness, so they can read as marks on the ground instead of stone you could stub a boot on, and nothing has crumbled — there is no loose rubble or scree around a broken slab.",
		],
	},
	{
		"version": "0.18.0",
