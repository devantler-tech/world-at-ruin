...
| Character ownership derives from the verified identity, never a client-supplied subject | `nakamacharacter.Store` | `TestSavePersistsPrivateVersionedCharacterForVerifiedAccount`, `TestSaveRejectsAnUnverifiedSubjectBeforeStorage`, `TestLoadRejectsAnUnverifiedSubjectBeforeStorage` |
